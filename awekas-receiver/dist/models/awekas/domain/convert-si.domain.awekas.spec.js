...
describe("toSI converts request to SI units", () => {
    it("Should convert to SI correctly", () => {
        expect((0, convert_si_domain_awekas_1.toSI)({
            barometer: 29.74,
            temperature: 63.8,
            dewPoint: 50.5,
            humidity: 52,
    ...
    it("Should not fail if value is null or undefined", () => {
        expect((0, convert_si_domain_awekas_1.toSI)(null)).toBeNull();
        expect((0, convert_si_domain_awekas_1.toSI)(undefined)).toBeUndefined();
    });
});
